...
public class GridItemDecoration extends ItemDecoration {
    ...
    private void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            if (mBuilder.isExistHeadView && i == 0) continue;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mBuilder.isExistHeadView) itemPosition -= 1;
    ...
    private void marginOffsets(Rect outRect, int spanCount, int itemPosition) {
        if (mBuilder.marginRight == 0 && mBuilder.marginLeft == 0) return;
    ...
    public static class Builder {
        ...
        /**
         * 设置divider的颜色 * * @param color * @return
         */
        ...
        /**
         * 单独设置横向divider的颜色 * * @param horColor * @return
         */
        ...
        /**
         * 单独设置纵向divider的颜色 * * @param verColor * @return
         */
        ...
        /**
         * 设置divider的宽度 * * @param size * @return
         */
        ...
        /**
         * 设置横向divider的宽度 * * @param horSize * @return
         */
        ...
        /**
         * 设置纵向divider的宽度 * * @param verSize * @return
         */
        ...
        /**
         * 设置剔除HeadView的RecyclerView左右两边的外间距 * * @param marginLeft * @param marginRight * @return
         */
        ...
        /**
         * 最后一行divider是否需要显示 * * @param isShow * @return
         */
        ...
        /**
         * 是否包含HeadView * * @param isExistHead * @return
         */
